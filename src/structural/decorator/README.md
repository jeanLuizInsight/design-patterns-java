...
Utilizando um exemplo do mundo real, há um troll furioso vivendo nas colinas próximas. Normalmente, ele sai de mãos vazias, mas às vezes tem uma arma. Para armar o troll não é necessário criar um novo troll, mas decorá-lo dinamicamente com uma arma adequada.
